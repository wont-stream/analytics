...
class DeviceDetector {
  constructor(options) {
    ...
    this.parse = (userAgent) => {
      ...
      const osName =
        (_a = result.os) === null || _a === void 0 ? void 0 : _a.name;
      const osVersion =
        (_b = result.os) === null || _b === void 0 ? void 0 : _b.version;
      const osFamily = OperatingSystemParser.getOsFamily(osName || "");
      if (
        !((_c = result.device) === null || _c === void 0 ? void 0 : _c.brand)
      ) {
       ...
       */
      if (
        !((_d = result.device) === null || _d === void 0 ? void 0 : _d.brand) &&
       ...
       */
      if (
        !((_e = result.device) === null || _e === void 0 ? void 0 : _e.type) &&
        osFamily === "Android" &&
       ...
       */
      if (
        (!((_f = result.device) === null || _f === void 0 ? void 0 : _f.type) &&
       ...
       */
      if (
        !((_g = result.device) === null || _g === void 0 ? void 0 : _g.type) &&
       ...
       */
      if (
        !((_h = result.device) === null || _h === void 0 ? void 0 : _h.type) &&
        osName === "Android" &&
        osVersion !== ""
      ) {
       ...
       */
      if (
        ((_j = result.device) === null || _j === void 0 ? void 0 : _j.type) ===
          "feature phone" &&
        osFamily === "Android"
      ) {
        result.device.type = "smartphone";
       ...
       */
      if (
        !((_k = result.device) === null || _k === void 0 ? void 0 : _k.type) &&
       ...
       */
      if (
        !((_l = result.device) === null || _l === void 0 ? void 0 : _l.type) &&
        ["Kylo", "Espial TV Browser"].includes(
          ((_m = result.client) === null || _m === void 0 ? void 0 : _m.name) ||
            ""
        )
      ) {
        if (!result.device) {
      ...
      const hasDesktop =
        "desktop" !==
          ((_o = result.device) === null || _o === void 0 ? void 0 : _o.type) &&
      ...
      if (
        !((_p = result.device) === null || _p === void 0 ? void 0 : _p.type) &&
    ...
    this.usesMobileBrowser = (client) => {
      ...
      return (
        ((_a = client) === null || _a === void 0 ? void 0 : _a.type) ===
          "browser" &&
        BrowserParser.isMobileOnlyBrowser(
          (_b = client) === null || _b === void 0 ? void 0 : _b.name
        )
      );
    };
    this.isToucheEnabled = (userAgent) => {
